...
export const SUBSCRIPTION_TIERS: {
  ...
  // Service Bureau Partner is consultation-only — NOT offered as a public,
  // self-serve recurring subscription. It remains assignable by an admin and
  // functional in the backend (see membershipLevels.ts / TIER_LEVEL).
];
