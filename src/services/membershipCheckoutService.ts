...
// Canonical membershipLevel string written to users/{uid} on a successful
// upgrade. Mirrors the renamed MembershipLevel enum values (back-compat for the
// old strings is handled by getTierRank's alias table).
export const TIER_LEVEL: Record<MembershipTier, string> = {
  associate: MembershipLevel.ACQUISITION,            // "Associate Partner"
  professional: MembershipLevel.PROFESSIONAL_PACKAGE, // "Professional Partner"
  premier: MembershipLevel.PREMIUM_PARTNER,          // "Premier Partner"
  service_bureau: MembershipLevel.SERVICE_BUREAU,    // "Service Bureau Partner"
};
