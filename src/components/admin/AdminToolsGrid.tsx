...
const TOOLS: Tool[] = [
  ...
  { label: 'Content Library', description: 'Category-gated member content', to: '/admin/content', icon: FolderOpen },
  { label: 'Admin Management', description: 'Add admins & change password', to: '/admin/admins', icon: Shield },
