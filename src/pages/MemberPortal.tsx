...
import { User, FileText, MessageSquare, CreditCard, Settings, Receipt, DollarSign, Bell, Upload, Lock, Megaphone, BarChart3 } from 'lucide-react';
    ...
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-6">
          ...
          <TabsContent value="analytics">{hasUpgradedAccess ? <ProfessionalAnalyticsDashboard /> : <UpgradePrompt feature="Analytics Dashboard" />}</TabsContent>
          <TabsContent value="marketing">{hasUpgradedAccess ? <MarketingMaterials /> : <UpgradePrompt feature="Marketing Materials" />}</TabsContent>
